...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    if BUY_ORDER_ITERATIONS > 0 {
        ...
        for i in 0..BUY_ORDER_ITERATIONS {
            ...
            let buy_order_call = market.open_order_call_handler(adjusted_fuel_volume_scaled, OrderType::Buy, price);
